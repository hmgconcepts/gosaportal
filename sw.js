...
const CACHE = 'sc-client-v12.7-20260925-14';
const CORE = ['./','./index.html','./login.html','./dashboard.html','./offline.html','./assets/css/style.css','./assets/js/config.js','./assets/js/app.js','./assets/js/crud.js','./assets/js/drive-sync.js','./assets/js/security-guard.js','./assets/js/cbt-engine.js','./assets/js/cbt-types.js','./assets/js/report-engine.js','./assets/js/notifications.js','./assets/js/voting.js','./assets/js/pwa-install.js','./assets/js/super.js','./assets/js/site-help.js','./assets/js/archive-hub.js','./assets/js/cbt-archive.js','./assets/js/recovery.js','./assets/js/data-portability.js','./assets/js/drive-sync.js','./assets/js/enterprise.js','./assets/js/analytics.js','./assets/img/logo.png','./manifest.json'];
